...
Добро пожаловать в репозиторий с электротехническими калькуляторами! Этот проект представляет собой веб-сайт, содержащий набор калькуляторов для расчёта различных электротехнических величин. Он разработан не разработчиками но для защиты проекта в предмете: "Учебная практика проектная практика". Спасибо что зашли к нам *^____^*
...
- **Широкий спектр калькуляторов:** Сайт содержит калькуляторы для расчёта основных электротехнических параметров, таких как ток короткого замыкания, мощность трехфазного трансформатора, вырабатываемая мощность солнечной панели и другие.
...
- **Адаптивный дизайн:** Сайт оптимизирован для использования на компьютерных устройствах
